  ...
  home() {
    return `
      <div class="sk-page" aria-busy="true" aria-label="${t('loading')}">
        ...
        <div style="margin:8px 0;">${this._card(`
          ${this._bar('40%', 12)}
          ${this._bar('70%', 24)}
          ${this._bar('55%', 12, 'sk-dim')}
        `)}</div>
        <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:6px;margin:4px auto 10px;max-width:340px;">
          ${this._card(`<div class="sk-bar sk-circle" style="margin:0 auto 8px;"></div>${this._bar('70%', 10)}`)}
          ${this._card(`<div class="sk-bar sk-circle" style="margin:0 auto 8px;"></div>${this._bar('70%', 10)}`)}
          ${this._card(`<div class="sk-bar sk-circle" style="margin:0 auto 8px;"></div>${this._bar('70%', 10)}`)}
          ${this._card(`<div class="sk-bar sk-circle" style="margin:0 auto 8px;"></div>${this._bar('70%', 10)}`)}
          ${this._card(`<div class="sk-bar sk-circle" style="margin:0 auto 8px;"></div>${this._bar('70%', 10)}`)}
