...
const PRIVACY_POLICY = {
  ...
  ar: {
    ...
    intro:
      'تطبيق «قُبى» رفيقك الإسلامي اليومي. خصوصيتك وأمان بياناتك أولوية قصوى لدينا، ' +
    ...
    consent: 'باستخدامك تطبيق «قُبى» فإنك توافق على سياسة الخصوصية هذه كما هي موضحة أعلاه.',
  },
