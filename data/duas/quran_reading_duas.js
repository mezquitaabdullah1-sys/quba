 ...
 *
 * v36: translation_es revisada (terminología castellana asentada de las
 *      ediciones publicadas de hadiz) + translation_ar con el texto árabe
 *      completo (antes estaba vacío y la interfaz árabe mostraba español).
 */
const QURAN_READING_DUAS = [
  {
    ...
    translation_es: 'Oh Dios, ábreme Tu sabiduría, extiende sobre mí Tu misericordia y recuérdame lo que haya olvidado, oh Poseedor de la majestad y la generosidad.',
    translation_ar: 'اللهم افتح علي حكمتك، وانشر علي رحمتك، وذكرني ما نسيت، يا ذا الجلال والإكرام',
  ...
  },
  {
    ...
    translation_es: 'Glorificado seas, oh Dios, y Te alabo. Atestiguo que no hay otra divinidad sino Tú. Te pido perdón y a Ti me retorno arrepentido.',
  ...
  },
  {
    ...
    translation_es: 'Oh Dios, ten misericordia de mí por medio del Corán, y haz que sea para mí una guía, una luz, un sendero y una misericordia. Oh Dios, recuérdame lo que haya olvidado de él, enséñame lo que ignore de él, y concédeme recitarlo durante las horas de la noche y en los extremos del día. Haz que sea un argumento a mi favor, oh Señor de los mundos.',
    translation_ar: 'اللهم ارحمني بالقرآن، واجعله لي إماما ونورا وهدى ورحمة، اللهم ذكرني منه ما نسيت، وعلمني منه ما جهلت، وارزقني تلاوته آناء الليل وأطراف النهار، واجعله لي حجة يا رب العالمين',
